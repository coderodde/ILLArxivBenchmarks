...
public class ILLBenchmark4Arxiv {
    ...
    public static class PrepopulatedBenchmarkState extends ListBenchmarkState {
        ...
        public List<Object> getCollectionList(int size) {
            List<Object> collectionList = new ArrayList<>(size);
    ...
    private static List<Object> prependCollection(final List<Object> list, final List<Object> collection) {
        list.addAll(0, collection);
        return list;
    }
    
    private static List<Object> appendCollection(final List<Object> list, final List<Object> collection) {
        list.addAll(collection);
        return list;
    }
    
    private static List<Object> insertCollection(final List<Object> list, final List<Object> collection) {
        list.addAll(list.size() / 2, collection);
        return list;
    }
    
    private static List<Object> removeRange(final List<Object> list, final int fromIndex, final int toIndex) {
    ...
    @Benchmark
    public List<Object> arrayListPrependCollection(final ArrayListPrepopulatedBenchmarkState state) {
        List<Object> targetList = state.getPopulatedList();
        List<Object> collectionList = state.getCollectionList(targetList.size() / 2);
        return prependCollection(targetList, collectionList);
    }

    @Benchmark
    public List<Object> arrayListAppendCollection(final ArrayListPrepopulatedBenchmarkState state) {
        List<Object> targetList = state.getPopulatedList();
        List<Object> collectionList = state.getCollectionList(targetList.size() / 2);
        return appendCollection(targetList, collectionList);
    }

    @Benchmark
    public List<Object> arrayListInsertCollection(final ArrayListPrepopulatedBenchmarkState state) {
        List<Object> targetList = state.getPopulatedList();
        List<Object> collectionList = state.getCollectionList(targetList.size() / 2);
        return insertCollection(targetList, collectionList);
    }

    @Benchmark
    public List<Object> arrayListRemoveRange(final ArrayListPrepopulatedBenchmarkState state) {
        List<Object> targetList = state.getPopulatedList();
        final int fromIndex = targetList.size() / 3;
        final int toIndex = targetList.size() - targetList.size() / 3;
        return removeRange(targetList, fromIndex, toIndex);
    }
    ...
    @Benchmark
    public List<Object> linkedListPrependCollection(final ArrayListPrepopulatedBenchmarkState state) {
        List<Object> targetList = state.getPopulatedList();
        List<Object> collectionList = state.getCollectionList(targetList.size() / 2);
        return prependCollection(targetList, collectionList);
    }
    ...
    @Benchmark
    public List<Object> linkedListAppendCollection(final ArrayListPrepopulatedBenchmarkState state) {
        List<Object> targetList = state.getPopulatedList();
        List<Object> collectionList = state.getCollectionList(targetList.size() / 2);
        return appendCollection(targetList, collectionList);
    }
    ...
    @Benchmark
    public List<Object> linkedListInsertCollection(final ArrayListPrepopulatedBenchmarkState state) {
        List<Object> targetList = state.getPopulatedList();
        List<Object> collectionList = state.getCollectionList(targetList.size() / 2);
        return insertCollection(targetList, collectionList);
    }
    ...
    @Benchmark
    public List<Object> linkedListRemoveRange(final ArrayListPrepopulatedBenchmarkState state) {
        List<Object> targetList = state.getPopulatedList();
        final int fromIndex = targetList.size() / 3;
        final int toIndex = targetList.size() - targetList.size() / 3;
        return removeRange(targetList, fromIndex, toIndex);
    ...
    @Benchmark
    public List<Object> treeListPrependCollection(final ArrayListPrepopulatedBenchmarkState state) {
        List<Object> targetList = state.getPopulatedList();
        List<Object> collectionList = state.getCollectionList(targetList.size() / 2);
        return prependCollection(targetList, collectionList);
    }
    ...
    @Benchmark
    public List<Object> treeListAppendCollection(final ArrayListPrepopulatedBenchmarkState state) {
        List<Object> targetList = state.getPopulatedList();
        List<Object> collectionList = state.getCollectionList(targetList.size() / 2);
        return appendCollection(targetList, collectionList);
    }
    ...
    @Benchmark
    public List<Object> treeListInsertCollection(final ArrayListPrepopulatedBenchmarkState state) {
        List<Object> targetList = state.getPopulatedList();
        List<Object> collectionList = state.getCollectionList(targetList.size() / 2);
        return insertCollection(targetList, collectionList);
    }
    ...
    @Benchmark
    public List<Object> treeListRemoveRange(final ArrayListPrepopulatedBenchmarkState state) {
        List<Object> targetList = state.getPopulatedList();
        final int fromIndex = targetList.size() / 3;
        final int toIndex = targetList.size() - targetList.size() / 3;
        return removeRange(targetList, fromIndex, toIndex);
    ...
    @Benchmark
    public List<Object> indexedListPrependCollection(final ArrayListPrepopulatedBenchmarkState state) {
        List<Object> targetList = state.getPopulatedList();
        List<Object> collectionList = state.getCollectionList(targetList.size() / 2);
        return prependCollection(targetList, collectionList);
    }
    ...
    @Benchmark
    public List<Object> indexedListAppendCollection(final ArrayListPrepopulatedBenchmarkState state) {
        List<Object> targetList = state.getPopulatedList();
        List<Object> collectionList = state.getCollectionList(targetList.size() / 2);
        return appendCollection(targetList, collectionList);
    }
    ...
    @Benchmark
    public List<Object> indexedListInsertCollection(final ArrayListPrepopulatedBenchmarkState state) {
        List<Object> targetList = state.getPopulatedList();
        List<Object> collectionList = state.getCollectionList(targetList.size() / 2);
        return insertCollection(targetList, collectionList);
    }
    ...
    @Benchmark
    public List<Object> indexedListRemoveRange(final ArrayListPrepopulatedBenchmarkState state) {
        List<Object> targetList = state.getPopulatedList();
        final int fromIndex = targetList.size() / 3;
        final int toIndex = targetList.size() - targetList.size() / 3;
        return removeRange(targetList, fromIndex, toIndex);
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (RunResult rr : results) {
            ...
            System.out.println(r.getLabel() + ": " + (long) r.getScore());
        }
    }
}
